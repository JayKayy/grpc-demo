...
const (
	Messenger_SendMessage_FullMethodName = "/Messenger/SendMessage"
)
...
func (c *messengerClient) SendMessage(ctx context.Context, in *Msg, opts ...grpc.CallOption) (*Msg, error) {
...
func (UnimplementedMessengerServer) SendMessage(context.Context, *Msg) (*Msg, error) {
...
func _Messenger_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessengerServer).SendMessage(ctx, req.(*Msg))
	}
